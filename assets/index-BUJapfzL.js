...
const BrandContext = reactExports.createContext(null);
const BrandProvider = ({
  children
}) => {
  const [brand, setBrand] = reactExports.useState("");
  const handleBrandChange = reactExports.useCallback((e) => {
...
function validateCvcNumber(value) {
  if (!isNumeric(value)) {
    return { isValid: false, errorMessage: ERROR_MESSAGE.INVALID_CHARACTER };
  }
...
const ExpiryDateContext = reactExports.createContext(null);
const EXPIRY_PLACEHOLDERS = ["MM", "YY"];
...
const NUMBER_PLACEHOLDERS = ["1234", "1234", "1234", "1234"];
...
const PreviewView = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PreviewContainer, { "data-testid": "preview-component", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardFrame, { backgroundColor: cardBrandColor, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardNumberArea, { children: numbers.map((number, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(CardNumber, { children: index < NUMBER_VISIBLE_THRESHOLD ? number : NUMBER_SHADE.repeat(number.length) }, index)) }),
...
const PreviewContainer = newStyled.div`
  display: flex;
...
const ICChip = newStyled.div`
  ...
  left: 12px;
`;
const CardNumberArea = newStyled.div`
  display: flex;
  flex-direction: row;
  justify-content: center;
  align-items: center;
...
const Preview = () => {
  ...
  const getCardBrandColor = () => {
    const key = brand;
    return theme.colors.cardBrandColors[key] || theme.colors.cardBrandColors.default;
  };
  const getCardMethodSrc = () => {
    ...
    if (prefixNumber >= MASTERCARD_PREFIX_RANGE.MIN && prefixNumber <= MASTERCARD_PREFIX_RANGE.MAX) {
...
const InputLabelsContainer = newStyled.div`
  width: 100%;
  margin-bottom: 16px;
`;
...
const InputTexts = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(InputTextsContainer, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Row$1, { children: Array.isArray(dataModels) ? dataModels.map((data, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Input,
      {
...
const Button = newStyled.button`
  width: 100%;
  background-color: ${({ theme: theme2 }) => theme2.colors.cardBrandColors.default};
  color: ${({ theme: theme2 }) => theme2.colors.cardText};
  font-size: ${({ theme: theme2 }) => theme2.fontSizes.button};
...
`;
const NumberInputs = () => {
  const { numberFields, handleNumbersChange, numberInputRefs } = useNumbersContext();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { "data-testid": "numbers-component", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      InputAreaHeader,
      {
...
const BrandSelect = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { "data-testid": "brand-component", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      InputAreaHeader,
      {
        title: "카드사를 선택해 주세요",
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Column, { children: [
        revealFlags[4] && /* @__PURE__ */ jsxRuntimeExports.jsx(PasswordInput, {}),
        revealFlags[3] && /* @__PURE__ */ jsxRuntimeExports.jsx(CVCNumberInput, {}),
        revealFlags[2] && /* @__PURE__ */ jsxRuntimeExports.jsx(ExpiryDateInputs, {}),
        revealFlags[1] && /* @__PURE__ */ jsxRuntimeExports.jsx(BrandSelect, {}),
        revealFlags[0] && /* @__PURE__ */ jsxRuntimeExports.jsx(NumberInputs, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(SubmitButton, {})
    ] })
  ] });
};
const Column = newStyled.div`
  display: flex;
  flex-direction: column;
  gap: 16px;
  width: 100%;
...
const CompletePage = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Center, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Notice, { children: [
      number,
      "로 시작하는",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ConfirmButton, { onClick, type: "button", children: "확인" })
  ] });
};
const Center = newStyled.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
  ...
  padding: 0 28px;
`;
const Notice = newStyled.h1`
  font-weight: ${({ theme: theme2 }) => theme2.fontWeights.bold};
  font-size: ${({ theme: theme2 }) => theme2.fontSizes.notice};
  line-height: 100%;
  letter-spacing: 0%;
  text-align: center;
  vertical-align: middle;
`;
const ConfirmButton = newStyled(Button)`
  border-radius: 5px;
  height: 44px;
`;
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { theme, children: /* @__PURE__ */ jsxRuntimeExports.jsx(NumbersProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrandProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(ExpiryDateProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CvcProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PasswordProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Main, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { basename: "/react-payments/", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
